      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Animated.View style={{ opacity: fadeAnim }}>
          ...
          <View style={[styles.catBadge, { backgroundColor: CATEGORY_COLORS.V + '20' }]}>
            <Text style={styles.catBadgeText}>Preferencias de aprendizaje</Text>
          </View>

          {/* Question */}
          <View style={styles.questionCard}>
            <LinearGradient
              colors={['rgba(124,58,237,0.12)', 'rgba(59,130,246,0.06)']}
          ...
          {/* Options */}
          <Text style={styles.chooseText}>Selecciona la opción que mejor te describe:</Text>
            ...
            return (
              ...
              >
                <View style={[styles.optionLetter, { backgroundColor: isSelected ? color : 'transparent', borderColor: color + '60' }]}>
                  <Text style={[styles.optionLetterText, { color: isSelected ? '#fff' : color }]}>
          ...
          <Text style={styles.progressText}>
            {BASIC_QUESTIONS.length - currentIndex - 1} preguntas restantes
          </Text>
        </Animated.View>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  optionBtn: {
    ...
    borderWidth: 1.5, borderColor: Colors.bg.glassBorder,
